		...
		<Dialog open={interacted} onOpenChange={setInteracted}>
			<DialogTrigger asChild>
				<Button
					variant="outline"
					size="lg"
					className="cursor-pointer border-border bg-transparent h-20 flex flex-col items-center justify-center space-y-2 transition-all hover:border-[#5865f2] hover:bg-[#5865f2]/10 active:scale-95"
				>
					<ListChecks className="size-6 shrink-0 text-[#5865f2]" />
