		...
		<div className="flex flex-col gap-6">
			<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between w-full">
				<div className="relative">
					<Icons.search className="size-4 shrink-0 absolute left-3 top-1/2 transform -translate-y-1/2 text-neutral-500" />
					<Input
						type="text"
				...
				<div className="flex items-center justify-between md:justify-end gap-4">
					...
					<div className="flex items-center border border-neutral-200 dark:border-neutral-700 rounded-sm p-1">
						...
						>
							<Icons.viewGrid className="size-4 shrink-0" />
						</Button>
						<Button
						...
						>
							<Icons.viewList className="size-4 shrink-0" />
						</Button>
					</div>
				</div>
			</div>
			<div
				className={
					viewMode === "grid"
						? "grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-5 md:gap-8"
						: "flex flex-col gap-3"
				}
			>
