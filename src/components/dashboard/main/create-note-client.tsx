...
export function CreateNoteClient() {
	...
	return (
		<Dialog open={interacted} onOpenChange={setInteracted}>
			<DialogTrigger className="cursor-pointer rounded-sm h-20 flex flex-col items-center justify-center space-y-2 border border-border transition-all hover:border-purple-600 hover:bg-purple-50 active:scale-95">
				<ScrollText className="size-6 shrink-0 text-purple-600" />
